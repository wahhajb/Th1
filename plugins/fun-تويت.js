...
const randomImage = tips[Math.floor(Math.random() * tips.length)];
   var messa = await prepareWAMessageMedia({ image: { url:'https://telegra.ph/file/89e452595ca0e3b1b8c7c.jpg' } }, { upload: conn.waUploadToServer });
...
handler.tags = ['frasss'];
handler.command = ['اسئله','اسئلة','تويت'];
