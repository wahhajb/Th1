...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    try {
        ...
        } else throw `*لازم تبعت صورة أو فيديو أو GIF عشان نعمل ملصق! 😅 ${usedPrefix + command}*`
    } catch {
        try {
            ...
            if (!stiker) {
                ...
                else return m.reply('*[❗𝐈𝐍𝐅𝐎❗] الرابط اللي بعتته مش شغال، لازم يكون بصيغة .jpg عشان نقدر نستخدمه! مثال: #s https://telegra.ph/file/0dc687c61410765e98de2.jpg*')
            }
        } catch {
            stiker = '*يجب عليك إرسال صورة أو فيديو علشان نعمل ملصق! 👀⌛*'
        }
    } finally {
        m.reply(stiker)
    }
