...
let handler = async (m, { conn, text }) => {
    ...
    if (!m.quoted && !text) {
        throw '*مرحبًا بك في بوت التربو! للحصول على قائمة الأوامر المتاحة، اكتب: .اوامر. استمتع بتجربة استخدام البوت!*';
    }
    ...
    m.reply('*شكرًا لاستخدامك بوت التربو! لاستكشاف المزيد من الميزات، اكتب .اوامر واستمتع بتجربة مميزة معنا.*');
};
