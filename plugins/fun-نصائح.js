...
const url = ['https://telegra.ph/file/a69f4e9cf361408214a3b.jpg', 
  ...
  const randomImage = tips[Math.floor(Math.random() * tips.length)];
   var messa = await prepareWAMessageMedia({ image: { url:'https://telegra.ph/file/363088f512856de747fa4.jpg' } }, { upload: conn.waUploadToServer });
    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          header: proto.Message.InteractiveMessage.Header.create({
            title: "*𓆩〘 نــــصــيــحــة 〙𓆪",
            subtitle: "𝙱𝙾𝚃 𝙴𝙻 𝚃𝙰𝚁𝙱𝙾𝙾",
...
handler.tags = ['frasss'];
handler.command = ['نصائح','نصيحه','نصيحة'];
