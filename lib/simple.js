	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363320110775982@newsletter',
            newsletterName: '┋𝐓𝐀𝐑𝐁𝐎𝐎 𝐁𝐎𝐓┋', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363320110775982@newsletter", "120363320110775982@newsletter", "120363320110775982@newsletter", "120363320110775982@newsletter","120363320110775982@newsletter","120363320110775982@newsletter","120363320110775982@newsletter","120363320110775982@newsletter"]
let canalNombre = ["•❬ 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 𝒕𝒂𝒓𝒃𝒐𝒐 𝒃𝒐𝒕 ❭•", "↓ 𝑇𝐴𝑅𝒃𝑂𝑂 𝑈𝑃𝐷𝐴𝑇𝐸 ↓", "ᵀᴬᴿᴮᴼᴼ ᴮᴼᵀ ᵂᴴᴬᵀˢᴬᴾᴾ", "┋𝐓𝐀𝐑𝐁𝐎𝐎 𝐁𝐎𝐓┋","TᗩᖇᗷOO ᗷOT ᗯᕼᗩTᔕᗩᑭᑭ","𝚃𝙰𝚁𝙱𝙾𝙾 𝙱𝙾𝚃 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿","✪┋𝐁𝐘┋❥ 𝐓𝐀𝐑𝐁𝐎𝐎☞𝐁𝐎𝐓 ┋✪","• 𝙱𝙾𝚃 𝙴𝙻 𝚃𝙰𝚁𝙱𝙾𝙾 | 🐼❤️) "]
